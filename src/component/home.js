...
export default function Home(props) {
  ...
  var nav = <NavbarSeller/>
    return (
        ...
        <Link to='/buyer/food'>
        <Carousel onClick={()=>{  console.log("clickeeed"); dispatch(getcategoryfood()) }}>
...
{/* //////////////////////////////////////////////////////////////////         */}
        ...
        <Carousel  onClick={()=>{  console.log("clickeeed"); dispatch(getcategoryclothes()) }}>
  <Carousel.Item interval={1000}  className="col-sm-6">
    <img
      className="d-block w-100"
...
{/* /////////////////////////////////////////////////////////////////////////////////////////////////// */}
       ...
       <div className="col-sm-6" >
        ...
        <Carousel onClick={()=>{  console.log("clickeeed"); dispatch(getcategoryacc()) }}>
 ...
 {/* //////////////////////////////////////////////////////////////////////////////       */}
        ...
        <Carousel  onClick={()=>{  console.log("clickeeed"); dispatch(getcategorybaby()) }}>
  <Carousel.Item interval={1000}>
    <img
      className="d-block w-100"
